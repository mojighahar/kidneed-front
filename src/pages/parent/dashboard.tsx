...
import {Typography, Box, Stack, Grid, Rating, Avatar, Paper, Button, IconButton} from '@mui/material'
  ...
  return (
      <Paper sx={{mt: 4, p: 3, boxShadow: 'none', borderRadius: 8}}>
        <Stack direction="row" justifyContent="space-between">
          ...
          <Box>
            <Button variant="outlined" size="large" startIcon={<EditIcon/>} sx={{
              color: '#8CA3A5',
              ...
              <Grid key={index} item xs={6} sx={{mt: 2}}>
                <Stack direction='row' alignItems='flex-start' spacing={3}>
                  ...
                  <Box>
                    ...
                    <Typography variant="h6" sx={{color: '#8CA3A5', mt: 1}}> {item.subtitle}</Typography>
                  </Box>
                </Stack>
              </Grid>
          ))}
        </Grid>
        <Box textAlign="center"><Button variant="outlined" startIcon={<AddIcon/>} fullWidth size="large" sx={{
          borderRadius: 8,
          height: 56,
          mt: 2,
          color: '#8CA3A5',
          ...
          maxWidth: '60%',
          margin: '16px auto 0'
        }}>افزودن برنامه ای جدید</Button></Box>
      </Paper>
  )
}
...
export default function Dashboard() {
  ...
  return <ParentDashboardLayout SideComponent={<SideDashboard />}>
    <Typography sx={{mb: 2}} variant="h4">سلام آقا محمد! 👋</Typography>
    <Grid style={{
      display: 'grid',
      ...
      <Grid item>
        <Box sx={{...styles.card, background: "#8BDA92"}}>
          <Box sx={styles.cardImage}><Image src={ImageCard1}/></Box>
      ...
      <Grid item>
        <Box sx={{...styles.card, background: "#FED150"}}>
          <Box sx={styles.cardImage}><Image src={ImageCard2}/></Box>
          <Box sx={styles.cardBottom}>
            <Typography variant="h3">21 ساعت</Typography>
            <Stack direction="row" justifyContent="space-between">
              <Typography variant="body1">مطالعه</Typography>
      ...
      <Grid item>
        <Box sx={{...styles.card, background: "#57ABF4"}}>
          <Box sx={styles.cardImage}><Image src={ImageCard3}/></Box>
          <Box sx={styles.cardBottom}>
            <Typography variant="h3">21 ساعت</Typography>
            <Stack direction="row" justifyContent="space-between">
              <Typography variant="body1">مطالعه</Typography>
